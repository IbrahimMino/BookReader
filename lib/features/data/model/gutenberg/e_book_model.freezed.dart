...
abstract class $FormatsCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: 'text/html; charset=utf-8') String? textHtml,
      @JsonKey(name: 'application/epub+zip') String? applicationEpubZip,
      @JsonKey(name: 'application/x-mobipocket-ebook')
...
class _$FormatsImpl implements _Formats {
  const _$FormatsImpl(
      {@JsonKey(name: 'text/html; charset=utf-8') this.textHtml,
      @JsonKey(name: 'application/epub+zip') this.applicationEpubZip,
      @JsonKey(name: 'application/x-mobipocket-ebook')
      this.applicationXMobipocketEbook,
      this.applicationRdfXml,
      @JsonKey(name: 'image/jpeg') this.imageJpeg,
      this.textPlainCharsetUsAscii,
      @JsonKey(name: 'application/octet-stream') this.applicationOctetStream});
...
abstract class _Formats implements Formats {
  const factory _Formats(
      {@JsonKey(name: 'text/html; charset=utf-8') final String? textHtml,
      @JsonKey(name: 'application/epub+zip') final String? applicationEpubZip,
      @JsonKey(name: 'application/x-mobipocket-ebook')
      final String? applicationXMobipocketEbook,
      final String? applicationRdfXml,
      @JsonKey(name: 'image/jpeg') final String? imageJpeg,
      final String? textPlainCharsetUsAscii,
      @JsonKey(name: 'application/octet-stream')
